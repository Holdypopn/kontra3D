...
public class EquipmentPanel : MonoBehaviour
{
    ...
    void Start()
    {
        Equipment.equipmentInstance.ItemAdded += InventoryScript_ItemChanged;
        Equipment.equipmentInstance.ItemRemoved += InventoryScript_ItemChanged;
        //Equipment.equipmentInstance.ItemSelected += InventoryScript_ItemSelected;
        Equipment.equipmentInstance.ItemSlotChanged += InventoryScript_ItemSlotChanged;
    }
